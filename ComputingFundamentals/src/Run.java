...
public class Run {
    public static void main(String[] args) {
        ...
        hyperHeuristics = MultiverseFramework.runMultipleMultiverse(problem, trainingSet, features, heuristics, 50, 120, true, seeds, "AllFeatures", 1, 2);

        MultiverseFramework.testMultipleHHFromXML(problem, trainingSet, "trainingSet", "hyperHeuristic", "AllFeatures", 1, 2);
